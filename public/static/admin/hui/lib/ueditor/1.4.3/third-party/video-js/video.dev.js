 ...
 *
 * To create a class that can be subclassed itself, extra the CoreObject class.
 *
 *     var Animal = CoreObject.extra();
 *     var Horse = Animal.extra();
 *
...
// because of the use of the extra/create class methods
...
vjs.Slider.prototype.update = function(){
  ...
  // so that it doesn't fall short of or extra past the handle.
  if (handle) {
...
vjs.MediaTechController.prototype.removeControlsListeners = function(){
  ...
  // listeners added by techs that extra this.
  this.off('tap');
  this.off('touchstart');
  this.off('touchmove');
  this.off('touchleave');
