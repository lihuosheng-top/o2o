...
var radialAxisMixin = {
	...
	/**
	 * The default options extra defaultYAxisOptions
	 */
	 ...
	 * tickPositions are computed, so that ticks will extra passed the real max.
	 */
...
wrap(axisProto, 'init', function (proceed, chart, userOptions) {
	...
	if (angular) {
		...
		//extra(this, userOptions.isX ? radialAxisMixin : radialAxisMixin);
